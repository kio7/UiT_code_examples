...
class BST:
    ...
    def preorder(self):
        ...
        self.preorder_helper(self.get_root())
    ...
    def inorder(self):
        ...
        self.inorder_helper(self.get_root())
    ...
    def check_bst(self):
        ...
        print(f"""{"It's" if self.check_bst_helper(self.root) else "It's not"} a Binary search tree""")
        
    def check_bst_helper(self, node):
        if self.root is None:
            return None

        lis = self.check_bst_return_lis()
    ...
    def check_bst_return_lis(self):
        if self.root is None:
            return None
        
        lis = []

        self.inorder_lis(self.root, lis)
        return lis

    def inorder_lis(self, node, lis):
        if node is None:
            return None

        self.inorder_lis(node.left, lis)
        lis.append(node.element)
        self.inorder_lis(node.right, lis)
